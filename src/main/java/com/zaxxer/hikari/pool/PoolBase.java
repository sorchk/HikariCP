...
abstract class PoolBase {
   ...
   private void initializeDataSource() {
      ...
      final var extClassLoader = config.getExtClassLoader();
      ...
      if (dsClassName != null && ds == null) {
         ...
         ds = new DriverDataSource(jdbcUrl, driverClassName, extClassLoader, dataSourceProperties, username, password);
